...
def create_timestamp_log():
    ...
    #  file_name = "/home/asset/Desktop/work/wireless-deep-fuzzer-zigbee/Zigbee/zigbee_log/Philp_hue_light/Time_stamp_log/time_stamp_log_"+current_time+".txt"
     file_name = "/home/asset/qpfuzzer_ble/target-zephyr/log/Time_stamp_log/time_stamp_log_"+current_time+".txt"
...
def create_output_log():
    ...
    #  file_name = "/home/asset/Desktop/work/wireless-deep-fuzzer-zigbee/Zigbee/zigbee_log/Philp_hue_light/output_log/output_log_"+current_time+".txt"
     file_name = "/home/asset/qpfuzzer_ble/target-zephyr/log/output_log/output_log_"+current_time+".txt"
...
def run_client(file_name_o):
    ...
    cmd = "clear && ./run-postinput-loop.sh ./target-zephyr/inputs/sm_pairing_req.bin ./target-zephyr/inputs/sm_pairing_rsp.bin"
...
if __name__ == '__main__':
    ...
    #     # time.sleep(10)
    #     # p2.start()
    #     p2 = multiprocessing.Process(name='p2',target = run_client,args=(f_name_t,f_name_o,))
    #     p2.start()
