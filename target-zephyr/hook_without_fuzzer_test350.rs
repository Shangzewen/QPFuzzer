...
pub fn main(api) {
  ...
  fn apply_patches() {
    ...
    common::patch_address(0x1bd38, [0x04, 0x34, 0x00, 0x20]);
    ...
    common::patch_address(0x0001b03c, [0x4f, 0xf0, 0x20, 0x00]);
    // Fix memcmp on adv_ind addr check
    common::patch_address(0x0001b118, [0x4f, 0xf0, 0x20, 0x00]);
  }