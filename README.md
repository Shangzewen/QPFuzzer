...
For fuzzing the emulation, the fuzzing engine needs to be connected with the emulation engine to intercept the communication. [Zigbee patch for fuzzing](./target-zigbee/hook.rs) was required instead of 
[Zigbee patch](./target-zigbee/hook_ref.rs).
...
<details>
<summary><b>View Zigbee Exploits</b></summary>
